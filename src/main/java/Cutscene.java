...
public class Cutscene {
    ...
    public static void hudsonRiverIntro() {
        ...
        System.out.print("         ");
        gameSystems.printWithDelay("Mid-air, the figure skillfully executes a flip, ", 50);
        gameSystems.printWithDelay("gracefully adjusting their trajectory onto the", 50);
        System.out.print("\n         ");
